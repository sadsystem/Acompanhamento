  ...
  <div className="flex-1 flex flex-col bg-gradient-to-br from-slate-100 via-gray-50 to-green-100 overflow-hidden relative">
      ...
      <div className="text-center pt-8 pb-4 relative z-10">
        ...
        <div className="mt-3 text-xs text-gray-500 bg-white/50 backdrop-blur-sm rounded-lg px-3 py-2 inline-block border border-gray-200/50">
          <div className="font-mono text-green-700 font-semibold">v{import.meta.env.VITE_APP_VERSION || 'e6880e9-serverless'}</div>
          <div className="text-[10px] mt-1">Serverless Deploy: 02/09/2025</div>
